...
import { rondasApi, puntosQrApi, residencialApi, PuntoQR, AsignacionRonda, Casa } from '@/lib/api';
import { Play, CheckCircle, Navigation, MapPin, Plus, QrCode, Home, Shield } from 'lucide-react';
